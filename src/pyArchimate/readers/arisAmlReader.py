...
# TODO Cleanup and format to become a pyArchimate Readerc
    ...
    def _parse_elements(self, groups=None, orgs=None):
        ...
        for grp in groups:
            ...
            if '@TypeNum' in grp and 'AttrDef' in grp:
                name, props, desc = _get_attributes(grp)
                oo.append(name)
            ...
            if 'ObjDef' in grp:
                ...
                for o in objects:
                    ...
                    o_id = o['@ObjDef.ID']
                    o_uuid = 'id-' + o['GUID']
                    o_name, props, o_desc = _get_attributes(o)
        ...
        if 'FFTextOcc' in grp:
            ...
            for o in objects:
                ...
                if lbl_ref in labels_list:
                    ...
                    o_name, _, _ = _get_attributes(lbl, '\n')
                    pos = o['Position']
        ...
        for grp in groups:
            ...
            if 'Model' in grp:
                ...
                for m in models:
                    ...
                    view_name, model_props, desc = _get_attributes(m)
...
def _clean_nested_conns():
    ...
    nested_conns = [x for x in conns_list.values() 
...
def _get_attributes(o: dict, sep=' ') -> dict:
    """
