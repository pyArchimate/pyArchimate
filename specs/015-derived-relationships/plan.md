...
- **VII. System Integrity & Accuracy**: The derivation-rule table is the single source of truth for "what counts as implied," transcribed directly from the ArchiMate 3.2 §3.5 tables and unit-tested cell-by-cell so results are reproducible and traceable to the spec section that authorizes them. PASS.
