...
def test_svg_zorder_parent_before_children():
    ...
    parent = view.add(ref=None, x=100, y=100, w=200, h=200, node_type="Label", label="Parent Container")
    child = parent.add(ref=None, x=50, y=50, w=100, h=100, node_type="Label", label="Child Element")
...
def test_nested_elements_render_hierarchy():
    ...
    root = view.add(ref=None, x=0, y=0, w=400, h=400, node_type="Label", label="Root")
    level1 = root.add(ref=None, x=50, y=50, w=300, h=300, node_type="Label", label="Level1")
    level2 = level1.add(ref=None, x=50, y=50, w=200, h=200, node_type="Label", label="Level2")
    leaf = level2.add(ref=None, x=50, y=50, w=100, h=100, node_type="Label", label="Leaf")
