...
def step_three_relationships_with_docs(context):
    ...
    docs = [
        "First relationship documentation",
        "Second relationship documentation",
        "Third relationship documentation"
    ]
    context.relationships = []
...
def step_description_contains(context, expected_text):
    ...
    assert context.imported_rel.desc == expected_text, \
        f"Expected '{expected_text}', got '{context.imported_rel.desc}'"
