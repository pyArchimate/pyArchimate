...
class MyTestCase(unittest.TestCase):
    ...
    def test_merge_elem(self):
        ...
        n1 = v1.get_or_create_node(
            elem="App A", elem_type=ArchiType.ApplicationCollaboration, x=20, y=20, create_node=True, create_elem=True
        )
        n2 = v1.get_or_create_node(
            elem="App B", elem_type=ArchiType.ApplicationCollaboration, x=200, y=100, create_node=True, create_elem=True
        )
        n3 = v1.get_or_create_node(
            elem="App B.1", elem_type=ArchiType.ApplicationComponent, x=400, y=100, create_node=True, create_elem=True
        )
        n4 = v1.get_or_create_node(
            elem="App B.2", elem_type=ArchiType.ApplicationComponent, x=400, y=200, create_node=True, create_elem=True
        )
        v1.get_or_create_connection(
            rel=None, name="r23", source=n3, target=n2, rel_type=ArchiType.Flow, create_conn=True
        )
        v1.get_or_create_connection(
            rel=None, name="r24", source=n4, target=n2, rel_type=ArchiType.Flow, create_conn=True
        )
    ...
    def test_del_node(self):
        ...
        n1 = v.get_or_create_node(
            elem="APP", elem_type=ArchiType.ApplicationComponent, create_node=True, create_elem=True
        )
        ...
        n3 = n2.get_or_create_node(
            elem="APP C", elem_type=ArchiType.ApplicationComponent, create_node=True, create_elem=True
        )

        n4 = n2.get_or_create_node(
            elem="APP D", elem_type=ArchiType.ApplicationComponent, create_node=True, create_elem=True
        )
        m.get_or_create_relationship(
            rel_type=ArchiType.Composition, name="", source=n2.concept, target=n3.concept, create_rel=True
        )
        n1.view.get_or_create_connection(
            rel=None, name="Flow to", rel_type=ArchiType.Flow, source=n3, target=n1, create_conn=True
        )
        n2.resize()
        e2 = n2.concept
        n2b = v2.get_or_create_node(elem=e2, x=200, w=240, h=110, create_node=True)
    ...
    def test_add_conn(self):
        ...
        n3 = n2.get_or_create_node(
            elem="New one", elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
        )
        n2.resize()
        v.get_or_create_connection(
            rel=None, rel_type=ArchiType.Flow, name="flows to", source=n3, target=n, create_conn=True
        )
        m.write("out.xml")
    ...
    def test_del_view(self):
        ...
        r = m.add_relationship(source=e, target=e2, rel_type="Flow", name="Flows to")
        v = m.add(ArchiType.View, "New View using new method")
        m.add(ArchiType.View, name="View 2")
        n = v.add(e, 100, 150)
        n2 = v.add(e2, 40, 50)
        c = v.add_connection(r, n, n2)
        cid = c.uuid
    ...
    def test_export_import(self):
        ...
        m.prop("key", "val")
        # create elements
        app_x = m.add(concept_type="ApplicationCollaboration", name="APP X", uuid="id-d7af75c01dc5433a8846c802bf54a0f4")
        app_y = m.add(concept_type="ApplicationCollaboration", name="APP Y", uuid="id-7950c5bfb5284df190b8ce40b13fce5b")
        ...
        i1 = m.add(
            concept_type="ApplicationInterface",
            name="Application Interface",
            uuid="id-43b030e355bf4fa1ba833c13c2f94e93",
        )

        # create relationships
        m.add_relationship(source=app_x, target=x1, rel_type="Assignment", uuid="id-d0cfce5b20d5437db42105ffa52d5b7d")
        m.add_relationship(source=app_x, target=x2, rel_type="Assignment", uuid="id-b0ffc6c18ffa4a249d52842db3875d5f")
        m.add_relationship(source=app_y, target=y1, rel_type="Assignment", uuid="id-a3fbfce0c86e4840ba44d7a2ab980a66")
        m.add_relationship(source=x1, target=i1, rel_type="Serving", uuid="id-d9c7f88b5e99428fb93655ca4a9115f0")
        ...
        n_app_x.add(ref=x2, x=384, y=158, nested_rel_type=ArchiType.Assignment)
    ...
    def test_node_position(self):
        ...
        v = m.add(ArchiType.View, "View1")
        n1 = v.get_or_create_node(
            elem="E1", elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
        )

        n2 = v.get_or_create_node(
            elem="E2", elem_type=ArchiType.ApplicationComponent, x=200, y=0, create_elem=True, create_node=True
        )
        n2.x = 200
        n2.y = 0
    ...
    def test_distribute_conn(self):
        ...
        middle_node = v.get_or_create_node(
            elem_type=ArchiType.ApplicationCollaboration,
            elem="App",
            x=500,
            y=500,
            w=100,
        ...
        for i in range(1, 11):
            ...
            node.cx = x
            node.cy = y
            c = v.get_or_create_connection(
                rel=None, rel_type=ArchiType.Flow, name=str(i), source=middle_node, target=node, create_conn=True
            )
    ...
    def test_styles(self):
        ...
        v = m.add(ArchiType.View, "View1")
        n1 = v.get_or_create_node(
            elem_type=ArchiType.ApplicationCollaboration, elem="App 1", create_node=True, create_elem=True
        )
        n2 = v.get_or_create_node(
            elem_type=ArchiType.ApplicationCollaboration,
            elem="App 2",
        ...
        n3 = n2.get_or_create_node(
            elem_type=ArchiType.ApplicationCollaboration, elem="App 3", x=550, y=40, create_node=True, create_elem=True
        )
        conn = v.get_or_create_connection(
            rel=None, rel_type=ArchiType.Flow, name="Flows to", source=n1, target=n2, create_conn=True
        )
    ...
    def test_get_or_create(self):
        ...
        v = m.add(ArchiType.View, "view1")
        n1 = v.get_or_create_node(
            elem="Toto", elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
        )
        n2 = n1.get_or_create_node(
            elem="Coco", elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
        )
        n3 = n1.get_or_create_node(
            elem="Coco", elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
        )
    ...
    def test_center_resize(self):
        ...
        gr = v.get_or_create_node(elem="GROUP", elem_type=ArchiType.Grouping, create_elem=True, create_node=True)
        for i in range(0, 12):
            gr.get_or_create_node(
                elem="#" + str(i), elem_type=ArchiType.ApplicationComponent, create_elem=True, create_node=True
            )
    ...
    def test_xml_validation(self):
        ...
        m = Model()
        v = m.add(ArchiType.View, "View 1")
        e1 = v.get_or_create_node(
            elem="App1", elem_type=ArchiType.ApplicationComponent, create_node=True, create_elem=True
        )
    ...
    def test_model_validation(self):
        ...
        v = m.add(ArchiType.View, "view")
        n1 = v.get_or_create_node(
            elem="App1", elem_type=ArchiType.ApplicationCollaboration, create_node=True, create_elem=True
        )
        n2 = v.get_or_create_node(
    ...
    def test_conn_labels(self):
        m = Model("test")
        v = m.add(ArchiType.View, "view")
        a = v.get_or_create_node(
            elem="A", elem_type=ArchiType.ApplicationComponent, x=20, y=20, create_elem=True, create_node=True
        )
        b = v.get_or_create_node(
            elem="B", elem_type=ArchiType.ApplicationComponent, x=20, y=20, create_elem=True, create_node=True
        )
        c = v.get_or_create_connection(
            rel_type=ArchiType.Flow, target=a, source=b, name="I am flowing to", create_conn=True
        )
        c.show_label = False
        m.write("out.archimate", writer=Writers.archi)
        m2 = Model("test2")
