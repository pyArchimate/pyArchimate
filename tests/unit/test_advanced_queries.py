...
class TestAdvancedQueries:
    ...
    def test_find_by_hierarchy_path_single_level(self):
        ...
        m = Model('test-model')
        root = m.add(ArchiType.BusinessProcess, 'Root')
        other = m.add(ArchiType.BusinessProcess, 'Other')
    ...
    def test_find_by_hierarchy_path_wildcard_all_at_level(self):
        ...
        m = Model('test-model')
        root1 = m.add(ArchiType.BusinessProcess, 'Root')
        root2 = m.add(ArchiType.BusinessProcess, 'Root')
    ...
    def test_find_by_hierarchy_path_empty_path_returns_empty(self):
        ...
        m = Model('test-model')
        elem = m.add(ArchiType.BusinessProcess, 'Element')
