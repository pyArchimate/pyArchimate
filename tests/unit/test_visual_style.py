...
class TestSetVisualStyleBulk:
    ...
    def test_set_visual_style_all_properties(self):
        ...
        elem.set_visual_style(fill_color="red", line_color="blue", line_width=2.0, transparency=0.8)
...
class TestGetVisualStyle:
    ...
    def test_get_visual_style_all(self):
        ...
        assert style == {"fillColor": "#ff0000", "lineColor": "#0000ff", "lineWidth": 2.0, "transparency": 0.8}
